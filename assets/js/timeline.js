...
var timelineStepper =
  timeline === null || timeline === void 0
    ? void 0
    : timeline.querySelector(".".concat(DOM.timelineStepper));
var timelineStepTitle =
  timeline === null || timeline === void 0
    ? void 0
    : timeline.querySelector(".".concat(DOM.timelineStepTitle));
var timelineSlidesContainer =
  timeline === null || timeline === void 0
    ? void 0
    : timeline.querySelector(".".concat(DOM.timelineSlidesContainer));
var timelineSlides =
  timeline &&
  Array.from(timeline.querySelectorAll(".".concat(DOM.timelineSlide)));
...
function deactivateSteps() {
  ...
  steps === null || steps === void 0
    ...
    : steps.forEach(function (elem) {
        return elem.classList.remove("".concat(DOM.timelineStepActive));
      });
}
function activateCurrentStep(currentStep) {
  currentStep === null || currentStep === void 0
    ? void 0
    : currentStep.classList.add("".concat(DOM.timelineStepActive));
}
function deactivateSlides() {
  timelineSlides === null || timelineSlides === void 0
    ? void 0
    : timelineSlides.forEach(function (elem) {
...
function createStepActiveMarker() {
  ...
  setStepActiveMarkerProps(
    __assign({ stepActiveMarker: stepActiveMarker }, positionProps)
  );
}
function recalcStepActiveMarkerProps() {
  var stepActiveMarker =
    timeline === null || timeline === void 0
      ? void 0
      : timeline.querySelector(".".concat(DOM.timelineStepActiveMarker));
  var stepActiveMarkerProps = getStepActiveMarkerProps();
  if (!stepActiveMarkerProps) {
    return;
  }
  setStepActiveMarkerProps(
    __assign({ stepActiveMarker: stepActiveMarker }, stepActiveMarkerProps)
  );
}
function setStepActiveMarkerProps(_a) {
  var stepActiveMarker = _a.stepActiveMarker,
    posX = _a.posX,
    posY = _a.posY,
    width = _a.width;
  stepActiveMarker.style.setProperty(
    "".concat(STEP_ACTIVE_MARKEP_CUSTOM_PROPS.width),
    "".concat(width, "px")
  );
  stepActiveMarker.style.setProperty(
    "".concat(STEP_ACTIVE_MARKEP_CUSTOM_PROPS.posX),
    "".concat(posX, "px")
  );
  if (typeof posY === "number") {
    stepActiveMarker.style.setProperty(
      "".concat(STEP_ACTIVE_MARKEP_CUSTOM_PROPS.posY),
      "".concat(posY, "px")
    );
  }
}
...
function getCurrentStep() {
  var timelineSteps = Array.from(
    document.querySelectorAll(".".concat(DOM.timelineStep))
  );
...
function setSlideContainerHeight(height) {
  timelineSlidesContainer === null || timelineSlidesContainer === void 0
    ...
    : timelineSlidesContainer.style.setProperty(
        "".concat(SLIDES_CONTAINER_CUSTOM_PROPS.height),
        "".concat(height, "px")
      );
}
